        ...
        <Box>
          <Box className="container mt-2">
            <Box className="row d-flex justify-content-center align-items-center">
              ...
              <Box className="col-lg-3 col-sm-12 d-flex justify-content-center"w={"fit-content"}  overflow={"hidden"}>
                <img style={{objectFit:"contain", width:"100%", borderRadius:"20px"}}
      ...
      <Box >
        <Box className="container">
          <Box className="row">
            ...
            <box className="col-lg-6 col-sm-12"></box>
          </Box>
        </Box>
      </Box>
    </Box>
