              ...
              <Box className="row d-flex justify-content-center align-items-center">
                <Box className="col-lg-9 col-sm-12">
                  <Text fontSize={"24px"} textAlign={"center"}>
                    ...
                    Looking forward to start career in a reputed firm driven by
                    technology.
                  </Text>
                </Box>
                <Box
                  className="col-lg-3 col-sm-12 d-flex justify-content-center"
                  w={"fit-content"}
                  overflow={"hidden"}
                >
                  <img
        ...
        <Box className="py-5" position={"relative"} zIndex={"9"}>
          <Box className="container">
            <Box className="row">
                        ...
                        <AccordionItem>
                          ...
                          <AccordionPanel pb={4}>
                            <Text>
                              ...
                              love how JavaScript allows me to build interactive
                              and dynamic web applications while also having the
                              ability to expand into other areas like
                              server-side development and mobile app development
                              using frameworks like Node.js and React Native.
                            </Text>
                          </AccordionPanel>
                        </AccordionItem>
                        <AccordionItem>
              ...
              >
                <Box h={"100%"} className="row glass-bg">
